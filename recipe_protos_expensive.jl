...
recipe = Recipe{Smelter}("steel-plate", 35)
@RIN "iron-plate" 10
@ROUT "steel-plate" 1
...
recipe = Recipe{Assembler}("tank", 8)
@RIN "engine-unit" 64
@RIN "steel-plate" 100
@RIN "iron-gear-wheel" 30
...
recipe = Recipe{Assembler}("burner-mining-drill", 4)
@RIN "iron-gear-wheel" 6
@RIN "stone-furnace" 2
@RIN "iron-plate" 6
